 ...
 *
*/
#ifndef AIRDATABOOMSENSOR_HH_
#define AIRDATABOOMSENSOR_HH_
...
#include <custom_ros2_msgs/msg/airdata.hpp>


namespace custom
{
  /// \brief forward declarations
  class AirDataBoomSensorPrivate;

  /// \brief airspeed sensor with noise.
  class AirDataBoomSensor : public gz::sensors::Sensor
  {

    /// \brief constructor
    public: AirDataBoomSensor();

    /// \brief destructor
    public: virtual ~AirDataBoomSensor();
    ...
    public: void SetAngleOfAttack(double _angle_of_attack);
    public: double AngleOfAttack() const;

    public: void SetAngleOfSideSlip(double _angle_of_sideslip);
    public: double AngleOfSideSlip() const;
    ...
    private: std::unique_ptr<AirDataBoomSensorPrivate> dataPtr;
