 ...
 *
*/
#ifndef AIRDATABOOMSENSORSYSTEM_HH_
#define AIRDATABOOMSENSORSYSTEM_HH_
...
namespace custom
{
  ...
  {
    /// \brief Constructor
    public: explicit AirDataBoomSensorSystem();

    /// \brief Destructor
    public: ~AirDataBoomSensorSystem() override;
    ...
    private: std::unique_ptr<AirDataBoomSensorSystemPrivate> dataPtr;
  };
}
#endif
