...
#include "MulticopterMotorModelModified.hh"
...
class gz::sim::systems::MulticopterMotorModelModifiedPrivate
{
...
//////////////////////////////////////////////////
MulticopterMotorModelModified::MulticopterMotorModelModified()
  : dataPtr(std::make_unique<MulticopterMotorModelModifiedPrivate>())
{
}

//////////////////////////////////////////////////
void MulticopterMotorModelModified::Configure(const Entity &_entity,
    ...
    EventManager &/*_eventMgr*/)
{
  ...
  {
    gzerr << "MulticopterMotorModelModified plugin should be attached to a model "
  ...
  {
    gzerr << "MulticopterMotorModelModified found an empty jointName parameter. "
  ...
  {
    gzerr << "MulticopterMotorModelModified found an empty linkName parameter. "
           << "Failed to initialize.";
    return;
  }
  ...
  this->dataPtr->node.Subscribe(topic,
      &MulticopterMotorModelModifiedPrivate::OnActuatorMsg, this->dataPtr.get());
}

//////////////////////////////////////////////////
void MulticopterMotorModelModified::PreUpdate(const UpdateInfo &_info,
    EntityComponentManager &_ecm)
{
  GZ_PROFILE("MulticopterMotorModelModified::PreUpdate");
...
//////////////////////////////////////////////////
void MulticopterMotorModelModifiedPrivate::OnActuatorMsg(
...
//////////////////////////////////////////////////
void MulticopterMotorModelModifiedPrivate::UpdateForcesAndMoments(
    EntityComponentManager &_ecm)
{
  GZ_PROFILE("MulticopterMotorModelModifiedPrivate::UpdateForcesAndMoments");
  ...
  switch (this->motorType)
  {
    ...
    default:  // MotorType::kVelocity
    {
      ...
      link.AddWorldForce(_ecm,
                         worldPose->Rot().RotateVector(thrust*Vector3(1,0,0)));
...
GZ_ADD_PLUGIN(MulticopterMotorModelModified,
                    System,
                    MulticopterMotorModelModified::ISystemConfigure,
                    MulticopterMotorModelModified::ISystemPreUpdate)

GZ_ADD_PLUGIN_ALIAS(MulticopterMotorModelModified,
                          "gz::sim::systems::MulticopterMotorModelModified")
