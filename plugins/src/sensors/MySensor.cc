...
//////////////////////////////////////////////////
bool MySensor::Load(const sdf::Sensor &_sdf)
{
  auto type = gz::sensors::customType(_sdf);
  if ("mysensor" != type)
  {
    gzerr << "Trying to load [mysensor] sensor, but got type ["
  ...
  if (!_sdf.Element()->HasElement("gz:mysensor"))
  {
  ...
  auto customElem = _sdf.Element()->GetElement("gz:mysensor");
...
//////////////////////////////////////////////////
bool MySensor::Update(const std::chrono::steady_clock::duration &_now)
{
  gz::msgs::Double msg;
...
//////////////////////////////////////////////////
void MySensor::NewPosition(const gz::math::Vector3d &_pos)
{
...
//////////////////////////////////////////////////
const gz::math::Vector3d &MySensor::Position() const
{
  return this->prevPos;
}
